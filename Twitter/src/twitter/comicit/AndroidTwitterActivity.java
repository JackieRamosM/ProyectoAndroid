...
public class AndroidTwitterActivity extends Activity {
	...
	private static final String twitter_consumer_key = "1b5oqjSTZzDTETXX98ldw";
	private static final String twitter_secret_key = "as2Ev6BLbQebRy9q1VMzi4U5y3xgMmkiShvQdTQAx8";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d("longitud","=" +txtMensaje.toString().length() );
	 	...
	 	//postBtn.setBackgroundResource(R.drawable.tweetcaster);	
			...
			public void onClick(View v) {
				String review = txtMensaje.getText().toString();
				        ...
				        if( txtMensaje.getText().toString().length()>=140  |
				        		txtMensaje.getText().toString().length()<1
				        		)
				        	txtMensaje.setError(" mensaje muy largo o esta vacio");
				        else  {
			...
			public void onClick(View v) {
				if (mTwitter.hasAccessToken()) {
					...
					if (postToTwitter) {
						...
						username = (username.equals("")) ? "Sin Nombre"
								: username;
	 ...
	 //	btnReadA.setBackgroundResource(R.drawable.miren);
		...
		btnReadA.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
			        ...
			        if(txtMensaje.getText().toString().length()<5)
			        	txtMensaje.setError(" texto de busqueda debe ser ma largo");
			        else { //del if
	 	...
	 	//		 setContentView(R.layout.main);
					...
					// todo esto es para poner el dialogo de consultando			
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			String text = (msg.what == 0) ? "Tweet Posteado"
					: "Fallo el posteo en Twitter";

			Toast.makeText(AndroidTwitterActivity.this, text,
	...
	private final TwDialogListener mTwLoginDialogListener = new TwDialogListener() {
		...
		public void onComplete(String value) {
			...
			Toast.makeText(AndroidTwitterActivity.this,
					"Conectado a Twitter como " + username, Toast.LENGTH_LONG)
					.show();
			txtStatus.setText("Estado: Conectado");
		}
		...
		public void onError(String value) {
			...
			Toast.makeText(AndroidTwitterActivity.this,
					"Fallo conexión con Twitter", Toast.LENGTH_LONG).show();
